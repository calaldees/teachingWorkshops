...
* Be familiar with a class and has some indication of the class's background/skillet
...
* Be able to understand how to plan a KS3 lesson on programming
    ...
    * Consider using metaphors/analogies to convey abstract concepts (if relevant)
        * Clearly conveying to the learners they are 'metaphones'
...
Example Lesson (Model) - Year 7 DataStructures
----------------------------------------------
...
To be able to write complex programs we need to understand how computers structure data
* Read/Modify/Create complex data structures

* There is data all around you
* with these skills you can
* break complex data into smaller more manageable chunks
...
Task: Idea Generation: Physical Metaphors (30min)
-------------------------------------------------
...
>
> Chapter 8: Teaching of Concepts .2: Teaching through ananlogy and storytelling
